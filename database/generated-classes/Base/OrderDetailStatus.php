...
abstract class OrderDetailStatus implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OrderDetailStatusTableMap';
    ...
    /**
     * Initializes internal state of Base\OrderDetailStatus object.
     */
     ...
     * @return $this|\OrderDetailStatus The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[OrderDetailStatusTableMap::COL_ID] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[OrderDetailStatusTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setColor($v)
    {
        ...
        if ($this->color !== $v) {
            $this->color = $v;
            $this->modifiedColumns[OrderDetailStatusTableMap::COL_COLOR] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OrderDetailStatusTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OrderDetailStatusTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OrderDetailStatusTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OrderDetailStatusTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OrderDetailStatusTableMap::translateFieldName('Color', TableMap::TYPE_PHPNAME, $indexType)];
            $this->color = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OrderDetailStatusTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OrderDetailStatusTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = OrderDetailStatusTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\OrderDetailStatus'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OrderDetailStatusTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(OrderDetailStatusTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(OrderDetailStatusTableMap::COL_COLOR)) {
            $modifiedColumns[':p' . $index++]  = 'color';
        }
        if ($this->isColumnModified(OrderDetailStatusTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(OrderDetailStatusTableMap::COL_UPDATED_AT)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\OrderDetailStatus The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrderDetailStatusTableMap::COL_ID)) {
            $criteria->add(OrderDetailStatusTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(OrderDetailStatusTableMap::COL_DESCRIPTION)) {
            $criteria->add(OrderDetailStatusTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(OrderDetailStatusTableMap::COL_COLOR)) {
            $criteria->add(OrderDetailStatusTableMap::COL_COLOR, $this->color);
        }
        if ($this->isColumnModified(OrderDetailStatusTableMap::COL_CREATED_AT)) {
            $criteria->add(OrderDetailStatusTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(OrderDetailStatusTableMap::COL_UPDATED_AT)) {
            $criteria->add(OrderDetailStatusTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \OrderDetailStatus (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \OrderDetailStatus Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildOrderDetailStatus is new, it will return
        ...
        if (null === $this->collOrderDetails || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                $collOrderDetails = ChildOrderDetailQuery::create(null, $criteria)
                    ->filterByOrderDetailStatus($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildOrderDetailStatus The current object (for fluent API support)
     */
    public function setOrderDetails(Collection $orderDetails, ConnectionInterface $con = null)
    {
        ...
        foreach ($orderDetailsToDelete as $orderDetailRemoved) {
            $orderDetailRemoved->setOrderDetailStatus(null);
        }
    ...
    protected function doAddOrderDetail(ChildOrderDetail $orderDetail)
    {
        ...
        $orderDetail->setOrderDetailStatus($this);
    }
    ...
    public function removeOrderDetail(ChildOrderDetail $orderDetail)
    {
        if ($this->getOrderDetails()->contains($orderDetail)) {
            ...
            $orderDetail->setOrderDetailStatus(null);
        }
     ...
     * Otherwise if this OrderDetailStatus is new, it will return
     * an empty collection; or if this OrderDetailStatus has previously
     * been saved, it will retrieve related OrderDetails from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in OrderDetailStatus.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function setOrderDetailHistories(Collection $orderDetailHistories, ConnectionInterface $con = null)
    {
        ...
        foreach ($orderDetailHistoriesToDelete as $orderDetailHistoryRemoved) {
            $orderDetailHistoryRemoved->setOrderDetailStatus(null);
        }
    ...
    protected function doAddOrderDetailHistory(ChildOrderDetailHistory $orderDetailHistory)
    {
        ...
        $orderDetailHistory->setOrderDetailStatus($this);
    }
    ...
    public function removeOrderDetailHistory(ChildOrderDetailHistory $orderDetailHistory)
    {
        if ($this->getOrderDetailHistories()->contains($orderDetailHistory)) {
            ...
            $orderDetailHistory->setOrderDetailStatus(null);
        }
