...
abstract class OrderStatus implements ActiveRecordInterface
{
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[OrderStatusTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setColor($v)
    {
        ...
        if ($this->color !== $v) {
            $this->color = $v;
            $this->modifiedColumns[OrderStatusTableMap::COL_COLOR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OrderStatusTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OrderStatusTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(OrderStatusTableMap::COL_COLOR)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrderStatusTableMap::COL_DESCRIPTION)) {
            $criteria->add(OrderStatusTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(OrderStatusTableMap::COL_COLOR)) {
            $criteria->add(OrderStatusTableMap::COL_COLOR, $this->color);
        }
        if ($this->isColumnModified(OrderStatusTableMap::COL_CREATED_AT)) {
            $criteria->add(OrderStatusTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(OrderStatusTableMap::COL_UPDATED_AT)) {
            $criteria->add(OrderStatusTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildOrderStatus The current object (for fluent API support)
     */
    public function setOrderHistories(Collection $orderHistories, ConnectionInterface $con = null)
    {
        ...
        foreach ($orderHistoriesToDelete as $orderHistoryRemoved) {
            $orderHistoryRemoved->setOrderStatus(null);
        }
    ...
    public function setOrderss(Collection $orderss, ConnectionInterface $con = null)
    {
        ...
        foreach ($orderssToDelete as $ordersRemoved) {
            $ordersRemoved->setOrderStatus(null);
        }
