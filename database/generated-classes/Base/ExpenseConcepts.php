...
/**
 * Base class that represents a row from the 'expense_concepts' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class ExpenseConcepts implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ExpenseConceptsTableMap';
    ...
    /**
     * Initializes internal state of Base\ExpenseConcepts object.
     */
    ...
    /**
     * Compares this with another <code>ExpenseConcepts</code> instance.  If
     * <code>obj</code> is an instance of <code>ExpenseConcepts</code>, delegates to
     * <code>equals(ExpenseConcepts)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\ExpenseConcepts The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ExpenseConceptsTableMap::COL_ID] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[ExpenseConceptsTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ExpenseConceptsTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ExpenseConceptsTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ExpenseConceptsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ExpenseConceptsTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ExpenseConceptsTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ExpenseConceptsTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = ExpenseConceptsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ExpenseConcepts'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildExpenseConceptsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ExpenseConcepts::setDeleted()
     * @see ExpenseConcepts::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildExpenseConceptsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ExpenseConceptsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ExpenseConceptsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ExpenseConceptsTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(ExpenseConceptsTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(ExpenseConceptsTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }

        $sql = sprintf(
            'INSERT INTO expense_concepts (%s) VALUES (%s)',
    ...
    {
        $pos = ExpenseConceptsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ExpenseConcepts'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ExpenseConcepts'][$this->hashCode()] = true;
        $keys = ExpenseConceptsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ExpenseConcepts The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ExpenseConceptsTableMap::COL_ID)) {
            $criteria->add(ExpenseConceptsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ExpenseConceptsTableMap::COL_DESCRIPTION)) {
            $criteria->add(ExpenseConceptsTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(ExpenseConceptsTableMap::COL_CREATED_AT)) {
            $criteria->add(ExpenseConceptsTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(ExpenseConceptsTableMap::COL_UPDATED_AT)) {
            $criteria->add(ExpenseConceptsTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildExpenseConceptsQuery::create();
        $criteria->add(ExpenseConceptsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ExpenseConcepts (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ExpenseConcepts Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildExpenseConcepts is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildExpenseConcepts The current object (for fluent API support)
     */
    public function setExpenseReportss(Collection $expenseReportss, ConnectionInterface $con = null)
    {
        ...
        foreach ($expenseReportssToDelete as $expenseReportsRemoved) {
            $expenseReportsRemoved->setExpenseConcepts(null);
        }
    ...
    protected function doAddExpenseReports(ChildExpenseReports $expenseReports)
    {
        ...
        $expenseReports->setExpenseConcepts($this);
    }
    ...
    public function removeExpenseReports(ChildExpenseReports $expenseReports)
    {
        if ($this->getExpenseReportss()->contains($expenseReports)) {
            ...
            $expenseReports->setExpenseConcepts(null);
        }
     ...
     * Otherwise if this ExpenseConcepts is new, it will return
     * an empty collection; or if this ExpenseConcepts has previously
     * been saved, it will retrieve related ExpenseReportss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ExpenseConcepts.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(ExpenseConceptsTableMap::DEFAULT_STRING_FORMAT);
    }
