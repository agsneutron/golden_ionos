...
/**
 * Base class that represents a row from the 'priorities' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Priorities implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PrioritiesTableMap';
    ...
    /**
     * Initializes internal state of Base\Priorities object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Priorities</code> instance.  If
     * <code>obj</code> is an instance of <code>Priorities</code>, delegates to
     * <code>equals(Priorities)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\Priorities The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PrioritiesTableMap::COL_ID] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[PrioritiesTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setDays($v)
    {
        ...
        if ($this->days !== $v) {
            $this->days = $v;
            $this->modifiedColumns[PrioritiesTableMap::COL_DAYS] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PrioritiesTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PrioritiesTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PrioritiesTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PrioritiesTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PrioritiesTableMap::translateFieldName('Days', TableMap::TYPE_PHPNAME, $indexType)];
            $this->days = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PrioritiesTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PrioritiesTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = PrioritiesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Priorities'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPrioritiesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Priorities::setDeleted()
     * @see Priorities::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPrioritiesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PrioritiesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PrioritiesTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(PrioritiesTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(PrioritiesTableMap::COL_DAYS)) {
            $modifiedColumns[':p' . $index++]  = 'days';
        }
        if ($this->isColumnModified(PrioritiesTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(PrioritiesTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }

        $sql = sprintf(
            'INSERT INTO priorities (%s) VALUES (%s)',
    ...
    {
        $pos = PrioritiesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Priorities'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Priorities'][$this->hashCode()] = true;
        $keys = PrioritiesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Priorities The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PrioritiesTableMap::COL_ID)) {
            $criteria->add(PrioritiesTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PrioritiesTableMap::COL_DESCRIPTION)) {
            $criteria->add(PrioritiesTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(PrioritiesTableMap::COL_DAYS)) {
            $criteria->add(PrioritiesTableMap::COL_DAYS, $this->days);
        }
        if ($this->isColumnModified(PrioritiesTableMap::COL_CREATED_AT)) {
            $criteria->add(PrioritiesTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(PrioritiesTableMap::COL_UPDATED_AT)) {
            $criteria->add(PrioritiesTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildPrioritiesQuery::create();
        $criteria->add(PrioritiesTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Priorities (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Priorities Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildPriorities is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildPriorities The current object (for fluent API support)
     */
    public function setOrderss(Collection $orderss, ConnectionInterface $con = null)
    {
        ...
        foreach ($orderssToDelete as $ordersRemoved) {
            $ordersRemoved->setPriorities(null);
        }
     ...
     * Otherwise if this Priorities is new, it will return
     * an empty collection; or if this Priorities has previously
     * been saved, it will retrieve related Orderss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Priorities.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(PrioritiesTableMap::DEFAULT_STRING_FORMAT);
    }
