...
class OrderStatusTableMap extends TableMap
{
     ...
     */
    const COL_DESCRIPTION = 'order_status.description';

    /**
     * the column name for the color field
     */
    const COL_COLOR = 'order_status.color';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(OrderStatusTableMap::COL_ID, OrderStatusTableMap::COL_DESCRIPTION, OrderStatusTableMap::COL_COLOR, OrderStatusTableMap::COL_CREATED_AT, OrderStatusTableMap::COL_UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(OrderStatusTableMap::COL_ID => 0, OrderStatusTableMap::COL_DESCRIPTION => 1, OrderStatusTableMap::COL_COLOR => 2, OrderStatusTableMap::COL_CREATED_AT => 3, OrderStatusTableMap::COL_UPDATED_AT => 4, ),
    ...
    protected $normalizedColumnNameMap = [
        ...
        'description' => 'DESCRIPTION',
        'orderStatus.description' => 'DESCRIPTION',
        'OrderStatusTableMap::COL_DESCRIPTION' => 'DESCRIPTION',
        ...
        'color' => 'COLOR',
        'orderStatus.color' => 'COLOR',
        'OrderStatusTableMap::COL_COLOR' => 'COLOR',
        'COL_COLOR' => 'COLOR',
        'order_status.color' => 'COLOR',
        'CreatedAt' => 'CREATED_AT',
        'OrderStatus.CreatedAt' => 'CREATED_AT',
        'createdAt' => 'CREATED_AT',
        'orderStatus.createdAt' => 'CREATED_AT',
        'OrderStatusTableMap::COL_CREATED_AT' => 'CREATED_AT',
        'COL_CREATED_AT' => 'CREATED_AT',
        'created_at' => 'CREATED_AT',
        'order_status.created_at' => 'CREATED_AT',
        'UpdatedAt' => 'UPDATED_AT',
        'OrderStatus.UpdatedAt' => 'UPDATED_AT',
        'updatedAt' => 'UPDATED_AT',
        'orderStatus.updatedAt' => 'UPDATED_AT',
        'OrderStatusTableMap::COL_UPDATED_AT' => 'UPDATED_AT',
        'COL_UPDATED_AT' => 'UPDATED_AT',
        'updated_at' => 'UPDATED_AT',
        'order_status.updated_at' => 'UPDATED_AT',
    ];
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrderStatusTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(OrderStatusTableMap::COL_COLOR);
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(OrderStatusTableMap::COL_ID);
            $criteria->removeSelectColumn(OrderStatusTableMap::COL_DESCRIPTION);
            $criteria->removeSelectColumn(OrderStatusTableMap::COL_COLOR);
            $criteria->removeSelectColumn(OrderStatusTableMap::COL_CREATED_AT);
            $criteria->removeSelectColumn(OrderStatusTableMap::COL_UPDATED_AT);
        } else {
