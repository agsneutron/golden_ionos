...
class GroupsTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Icon', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'icon', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(GroupsTableMap::COL_ID, GroupsTableMap::COL_NAME, GroupsTableMap::COL_ICON, GroupsTableMap::COL_CREATED_AT, GroupsTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'icon', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Icon' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'icon' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(GroupsTableMap::COL_ID => 0, GroupsTableMap::COL_NAME => 1, GroupsTableMap::COL_ICON => 2, GroupsTableMap::COL_CREATED_AT => 3, GroupsTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'icon' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'icon' => 'ICON',
        'groups.icon' => 'ICON',
        'GroupsTableMap::COL_ICON' => 'ICON',
        'COL_ICON' => 'ICON',
        'CreatedAt' => 'CREATED_AT',
        'Groups.CreatedAt' => 'CREATED_AT',
        'createdAt' => 'CREATED_AT',
        'groups.createdAt' => 'CREATED_AT',
        'GroupsTableMap::COL_CREATED_AT' => 'CREATED_AT',
        'COL_CREATED_AT' => 'CREATED_AT',
        'created_at' => 'CREATED_AT',
        'groups.created_at' => 'CREATED_AT',
        'UpdatedAt' => 'UPDATED_AT',
        'Groups.UpdatedAt' => 'UPDATED_AT',
        'updatedAt' => 'UPDATED_AT',
        'groups.updatedAt' => 'UPDATED_AT',
        'GroupsTableMap::COL_UPDATED_AT' => 'UPDATED_AT',
        'COL_UPDATED_AT' => 'UPDATED_AT',
        'updated_at' => 'UPDATED_AT',
        'groups.updated_at' => 'UPDATED_AT',
    ];
    ...
    {
        $this->addRelation('Modules', '\\Modules', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id_group',
    1 => ':id',
  ),
), null, 'CASCADE', 'Moduless', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupsTableMap::COL_ICON);
    ...
    public static function removeSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(GroupsTableMap::COL_ICON);
            $criteria->removeSelectColumn(GroupsTableMap::COL_CREATED_AT);
            $criteria->removeSelectColumn(GroupsTableMap::COL_UPDATED_AT);
        } else {
