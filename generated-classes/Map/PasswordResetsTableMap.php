...
class PasswordResetsTableMap extends TableMap
{
    ...
    protected $normalizedColumnNameMap = [
        ...
        'email' => 'EMAIL',
        'passwordResets.email' => 'EMAIL',
        'PasswordResetsTableMap::COL_EMAIL' => 'EMAIL',
        'COL_EMAIL' => 'EMAIL',
        ...
        'token' => 'TOKEN',
        'passwordResets.token' => 'TOKEN',
        'PasswordResetsTableMap::COL_TOKEN' => 'TOKEN',
        'COL_TOKEN' => 'TOKEN',
        'password_resets.token' => 'TOKEN',
        'CreatedAt' => 'CREATED_AT',
        'PasswordResets.CreatedAt' => 'CREATED_AT',
        'createdAt' => 'CREATED_AT',
        'passwordResets.createdAt' => 'CREATED_AT',
        'PasswordResetsTableMap::COL_CREATED_AT' => 'CREATED_AT',
        'COL_CREATED_AT' => 'CREATED_AT',
        'created_at' => 'CREATED_AT',
        'password_resets.created_at' => 'CREATED_AT',
    ];
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(PasswordResetsTableMap::COL_EMAIL);
            $criteria->removeSelectColumn(PasswordResetsTableMap::COL_TOKEN);
            $criteria->removeSelectColumn(PasswordResetsTableMap::COL_CREATED_AT);
        } else {
