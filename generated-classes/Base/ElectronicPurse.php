...
/**
 * Base class that represents a row from the 'electronic_purse' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class ElectronicPurse implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ElectronicPurseTableMap';
    ...
    /**
     * Initializes internal state of Base\ElectronicPurse object.
     */
    ...
    /**
     * Compares this with another <code>ElectronicPurse</code> instance.  If
     * <code>obj</code> is an instance of <code>ElectronicPurse</code>, delegates to
     * <code>equals(ElectronicPurse)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\ElectronicPurse The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ElectronicPurseTableMap::COL_ID] = true;
        }
    ...
    public function setIdClientUser($v)
    {
        ...
        if ($this->id_client_user !== $v) {
            ...
            $this->modifiedColumns[ElectronicPurseTableMap::COL_ID_CLIENT_USER] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[ElectronicPurseTableMap::COL_CODE] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[ElectronicPurseTableMap::COL_AMOUNT] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ElectronicPurseTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ElectronicPurseTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ElectronicPurseTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ElectronicPurseTableMap::translateFieldName('IdClientUser', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_client_user = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ElectronicPurseTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ElectronicPurseTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ElectronicPurseTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ElectronicPurseTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = ElectronicPurseTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ElectronicPurse'), 0, $e);
        }
    }
    ...
    {
        if ($this->aUsers !== null && $this->id_client_user !== $this->aUsers->getId()) {
            $this->aUsers = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildElectronicPurseQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ElectronicPurse::setDeleted()
     * @see ElectronicPurse::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildElectronicPurseQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ElectronicPurseTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->electronicPurseHistoriesScheduledForDeletion !== null) {
                if (!$this->electronicPurseHistoriesScheduledForDeletion->isEmpty()) {
                    \ElectronicPurseHistoryQuery::create()
                        ->filterByPrimaryKeys($this->electronicPurseHistoriesScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ElectronicPurseTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ElectronicPurseTableMap::COL_ID_CLIENT_USER)) {
            $modifiedColumns[':p' . $index++]  = 'id_client_user';
        }
        if ($this->isColumnModified(ElectronicPurseTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(ElectronicPurseTableMap::COL_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'amount';
        }
        if ($this->isColumnModified(ElectronicPurseTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(ElectronicPurseTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }

        $sql = sprintf(
            'INSERT INTO electronic_purse (%s) VALUES (%s)',
    ...
    {
        $pos = ElectronicPurseTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ElectronicPurse'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ElectronicPurse'][$this->hashCode()] = true;
        $keys = ElectronicPurseTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getIdClientUser(),
            $keys[2] => $this->getCode(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setIdClientUser($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ElectronicPurse The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ElectronicPurseTableMap::COL_ID)) {
            $criteria->add(ElectronicPurseTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ElectronicPurseTableMap::COL_ID_CLIENT_USER)) {
            $criteria->add(ElectronicPurseTableMap::COL_ID_CLIENT_USER, $this->id_client_user);
        }
        if ($this->isColumnModified(ElectronicPurseTableMap::COL_CODE)) {
            $criteria->add(ElectronicPurseTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(ElectronicPurseTableMap::COL_AMOUNT)) {
            $criteria->add(ElectronicPurseTableMap::COL_AMOUNT, $this->amount);
        }
        if ($this->isColumnModified(ElectronicPurseTableMap::COL_CREATED_AT)) {
            $criteria->add(ElectronicPurseTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(ElectronicPurseTableMap::COL_UPDATED_AT)) {
            $criteria->add(ElectronicPurseTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildElectronicPurseQuery::create();
        $criteria->add(ElectronicPurseTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ElectronicPurse (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ElectronicPurse Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aUsers === null && ($this->id_client_user != 0)) {
            $this->aUsers = ChildUsersQuery::create()->findPk($this->id_client_user, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsers->addElectronicPurses($this);
             */
        }
     ...
     * If this ChildElectronicPurse is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildElectronicPurse The current object (for fluent API support)
     */
    public function setElectronicPurseHistories(Collection $electronicPurseHistories, ConnectionInterface $con = null)
    {
        ...
        foreach ($electronicPurseHistoriesToDelete as $electronicPurseHistoryRemoved) {
            $electronicPurseHistoryRemoved->setElectronicPurse(null);
        }
    ...
    protected function doAddElectronicPurseHistory(ChildElectronicPurseHistory $electronicPurseHistory)
    {
        ...
        $electronicPurseHistory->setElectronicPurse($this);
    }
    ...
    public function removeElectronicPurseHistory(ChildElectronicPurseHistory $electronicPurseHistory)
    {
        if ($this->getElectronicPurseHistories()->contains($electronicPurseHistory)) {
            ...
            $this->electronicPurseHistoriesScheduledForDeletion[]= clone $electronicPurseHistory;
            $electronicPurseHistory->setElectronicPurse(null);
        }
     ...
     * Otherwise if this ElectronicPurse is new, it will return
     * an empty collection; or if this ElectronicPurse has previously
     * been saved, it will retrieve related ElectronicPurseHistories from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ElectronicPurse.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildElectronicPurseHistory}> List of ChildElectronicPurseHistory objects
     */
    public function getElectronicPurseHistoriesJoinOrders(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildElectronicPurseHistoryQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aUsers) {
            $this->aUsers->removeElectronicPurse($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(ElectronicPurseTableMap::DEFAULT_STRING_FORMAT);
    }
