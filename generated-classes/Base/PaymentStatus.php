...
/**
 * Base class that represents a row from the 'payment_status' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class PaymentStatus implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PaymentStatusTableMap';
    ...
    /**
     * Initializes internal state of Base\PaymentStatus object.
     */
    ...
    /**
     * Compares this with another <code>PaymentStatus</code> instance.  If
     * <code>obj</code> is an instance of <code>PaymentStatus</code>, delegates to
     * <code>equals(PaymentStatus)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\PaymentStatus The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PaymentStatusTableMap::COL_ID] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[PaymentStatusTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PaymentStatusTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PaymentStatusTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PaymentStatusTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PaymentStatusTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PaymentStatusTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PaymentStatusTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = PaymentStatusTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PaymentStatus'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPaymentStatusQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PaymentStatus::setDeleted()
     * @see PaymentStatus::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPaymentStatusQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PaymentStatusTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->orderHistoriesScheduledForDeletion !== null) {
                if (!$this->orderHistoriesScheduledForDeletion->isEmpty()) {
                    foreach ($this->orderHistoriesScheduledForDeletion as $orderHistory) {
                        // need to save related object because we set the relation to null
                        $orderHistory->save($con);
                    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[PaymentStatusTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PaymentStatusTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(PaymentStatusTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(PaymentStatusTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(PaymentStatusTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(PaymentStatusTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }

        $sql = sprintf(
            'INSERT INTO payment_status (%s) VALUES (%s)',
    ...
    {
        $pos = PaymentStatusTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PaymentStatus'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PaymentStatus'][$this->hashCode()] = true;
        $keys = PaymentStatusTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PaymentStatus The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(PaymentStatusTableMap::DATABASE_NAME);

        if ($this->isColumnModified(PaymentStatusTableMap::COL_ID)) {
            $criteria->add(PaymentStatusTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PaymentStatusTableMap::COL_DESCRIPTION)) {
            $criteria->add(PaymentStatusTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(PaymentStatusTableMap::COL_CREATED_AT)) {
            $criteria->add(PaymentStatusTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(PaymentStatusTableMap::COL_UPDATED_AT)) {
            $criteria->add(PaymentStatusTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildPaymentStatusQuery::create();
        $criteria->add(PaymentStatusTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PaymentStatus (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PaymentStatus Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildPaymentStatus is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildPaymentStatus The current object (for fluent API support)
     */
    public function setOrderHistories(Collection $orderHistories, ConnectionInterface $con = null)
    {
        ...
        foreach ($orderHistoriesToDelete as $orderHistoryRemoved) {
            $orderHistoryRemoved->setPaymentStatus(null);
        }
    ...
    protected function doAddOrderHistory(ChildOrderHistory $orderHistory)
    {
        ...
        $orderHistory->setPaymentStatus($this);
    }
    ...
    public function removeOrderHistory(ChildOrderHistory $orderHistory)
    {
        if ($this->getOrderHistories()->contains($orderHistory)) {
            ...
            $this->orderHistoriesScheduledForDeletion[]= $orderHistory;
            $orderHistory->setPaymentStatus(null);
        }
     ...
     * Otherwise if this PaymentStatus is new, it will return
     * an empty collection; or if this PaymentStatus has previously
     * been saved, it will retrieve related OrderHistories from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PaymentStatus.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(PaymentStatusTableMap::DEFAULT_STRING_FORMAT);
    }
