 ...
 * @method     ChildOrderStatusQuery orderByDescription($order = Criteria::ASC) Order by the description column
 ...
 * @method     ChildOrderStatusQuery groupByDescription() Group by the description column
 ...
 *
 * @method     ChildOrderStatusQuery leftJoinOrderHistory($relationAlias = null) Adds a LEFT JOIN clause to the query using the OrderHistory relation
 * @method     ChildOrderStatusQuery rightJoinOrderHistory($relationAlias = null) Adds a RIGHT JOIN clause to the query using the OrderHistory relation
 * @method     ChildOrderStatusQuery innerJoinOrderHistory($relationAlias = null) Adds a INNER JOIN clause to the query using the OrderHistory relation
 *
 * @method     ChildOrderStatusQuery joinWithOrderHistory($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the OrderHistory relation
 *
 * @method     ChildOrderStatusQuery leftJoinWithOrderHistory() Adds a LEFT JOIN clause and with to the query using the OrderHistory relation
 * @method     ChildOrderStatusQuery rightJoinWithOrderHistory() Adds a RIGHT JOIN clause and with to the query using the OrderHistory relation
 * @method     ChildOrderStatusQuery innerJoinWithOrderHistory() Adds a INNER JOIN clause and with to the query using the OrderHistory relation
 *
 * @method     ChildOrderStatusQuery leftJoinOrders($relationAlias = null) Adds a LEFT JOIN clause to the query using the Orders relation
 * @method     ChildOrderStatusQuery rightJoinOrders($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Orders relation
 * @method     ChildOrderStatusQuery innerJoinOrders($relationAlias = null) Adds a INNER JOIN clause to the query using the Orders relation
 *
 * @method     ChildOrderStatusQuery joinWithOrders($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Orders relation
 *
 * @method     ChildOrderStatusQuery leftJoinWithOrders() Adds a LEFT JOIN clause and with to the query using the Orders relation
 * @method     ChildOrderStatusQuery rightJoinWithOrders() Adds a RIGHT JOIN clause and with to the query using the Orders relation
 * @method     ChildOrderStatusQuery innerJoinWithOrders() Adds a INNER JOIN clause and with to the query using the Orders relation
 *
 ...
 *
 * @method     ChildOrderStatus|null findOneById(int $id) Return the first ChildOrderStatus filtered by the id column
 * @method     ChildOrderStatus|null findOneByDescription(string $description) Return the first ChildOrderStatus filtered by the description column
 * @method     ChildOrderStatus|null findOneByColor(string $color) Return the first ChildOrderStatus filtered by the color column
 * @method     ChildOrderStatus|null findOneByCreatedAt(string $created_at) Return the first ChildOrderStatus filtered by the created_at column
 * @method     ChildOrderStatus|null findOneByUpdatedAt(string $updated_at) Return the first ChildOrderStatus filtered by the updated_at column *
 ...
 * @method     ChildOrderStatus requireOneByDescription(string $description) Return the first ChildOrderStatus filtered by the description column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildOrderStatus requireOneByColor(string $color) Return the first ChildOrderStatus filtered by the color column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildOrderStatus requireOneByCreatedAt(string $created_at) Return the first ChildOrderStatus filtered by the created_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildOrderStatus requireOneByUpdatedAt(string $updated_at) Return the first ChildOrderStatus filtered by the updated_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildOrderStatus> find(ConnectionInterface $con = null) Return ChildOrderStatus objects based on current ModelCriteria
 * @method     ChildOrderStatus[]|ObjectCollection findById(int $id) Return ChildOrderStatus objects filtered by the id column
 * @psalm-method ObjectCollection&\Traversable<ChildOrderStatus> findById(int $id) Return ChildOrderStatus objects filtered by the id column
 * @method     ChildOrderStatus[]|ObjectCollection findByDescription(string $description) Return ChildOrderStatus objects filtered by the description column
 * @psalm-method ObjectCollection&\Traversable<ChildOrderStatus> findByDescription(string $description) Return ChildOrderStatus objects filtered by the description column
 * @method     ChildOrderStatus[]|ObjectCollection findByColor(string $color) Return ChildOrderStatus objects filtered by the color column
 * @psalm-method ObjectCollection&\Traversable<ChildOrderStatus> findByColor(string $color) Return ChildOrderStatus objects filtered by the color column
 * @method     ChildOrderStatus[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildOrderStatus objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildOrderStatus> findByCreatedAt(string $created_at) Return ChildOrderStatus objects filtered by the created_at column
 * @method     ChildOrderStatus[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildOrderStatus objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildOrderStatus> findByUpdatedAt(string $updated_at) Return ChildOrderStatus objects filtered by the updated_at column
...
abstract class OrderStatusQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'golden_clean', $modelName = '\\OrderStatus', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, description, color, created_at, updated_at FROM order_status WHERE id = :p0';
        try {
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(OrderStatusTableMap::COL_DESCRIPTION, $description, $comparison);
    }
    ...
    public function filterByColor($color = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(OrderStatusTableMap::COL_COLOR, $color, $comparison);
    }
    ...
    public function filterByOrderHistory($orderHistory, $comparison = null)
    {
        if ($orderHistory instanceof \OrderHistory) {
            return $this
                ->addUsingAlias(OrderStatusTableMap::COL_ID, $orderHistory->getIdOrderStatus(), $comparison);
    ...
    public function filterByOrders($orders, $comparison = null)
    {
        if ($orders instanceof \Orders) {
            return $this
                ->addUsingAlias(OrderStatusTableMap::COL_ID, $orders->getIdOrderStatus(), $comparison);
