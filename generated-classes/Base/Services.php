...
abstract class Services implements ActiveRecordInterface
{
    ...
    /**
     * The value for the id_service_category field.
     *
     * @var        int
     */
    ...
    /**
     * @var        ChildServiceCategories
     */
    protected $aServiceCategories;
    ...
    /**
     * Get the [id_service_category] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [id_service_category] column.
     *
     * @param int $v New value
     * @return $this|\Services The current object (for fluent API support)
     */
    public function setIdServiceCategory($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_service_category !== $v) {
            $this->id_service_category = $v;
            $this->modifiedColumns[ServicesTableMap::COL_ID_SERVICE_CATEGORY] = true;
        }

        if ($this->aServiceCategories !== null && $this->aServiceCategories->getId() !== $v) {
            $this->aServiceCategories = null;
        }

        return $this;
    } // setIdServiceCategory()
    ...
    public function setNormalPrice($v)
    {
        ...
        if ($this->normal_price !== $v) {
            $this->normal_price = $v;
            $this->modifiedColumns[ServicesTableMap::COL_NORMAL_PRICE] = true;
        }
    ...
    public function setUrgentPrice($v)
    {
        ...
        if ($this->urgent_price !== $v) {
            $this->urgent_price = $v;
            $this->modifiedColumns[ServicesTableMap::COL_URGENT_PRICE] = true;
        }
    ...
    public function setExtraUrgentPrice($v)
    {
        ...
        if ($this->extra_urgent_price !== $v) {
            ...
            $this->modifiedColumns[ServicesTableMap::COL_EXTRA_URGENT_PRICE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ServicesTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ServicesTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ServicesTableMap::translateFieldName('IdServiceCategory', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_service_category = (null !== $col) ? (int) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ServicesTableMap::translateFieldName('NormalPrice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->normal_price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ServicesTableMap::translateFieldName('UrgentPrice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->urgent_price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ServicesTableMap::translateFieldName('ExtraUrgentPrice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->extra_urgent_price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ServicesTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ServicesTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 8; // 8 = ServicesTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aServiceCategories !== null && $this->id_service_category !== $this->aServiceCategories->getId()) {
            $this->aServiceCategories = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aServiceCategories !== null) {
                if ($this->aServiceCategories->isModified() || $this->aServiceCategories->isNew()) {
                    $affectedRows += $this->aServiceCategories->save($con);
                }
                $this->setServiceCategories($this->aServiceCategories);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ServicesTableMap::COL_ID_SERVICE_CATEGORY)) {
            $modifiedColumns[':p' . $index++]  = 'id_service_category';
        }
        if ($this->isColumnModified(ServicesTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(ServicesTableMap::COL_NORMAL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'normal_price';
        }
        if ($this->isColumnModified(ServicesTableMap::COL_URGENT_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'urgent_price';
        }
        if ($this->isColumnModified(ServicesTableMap::COL_EXTRA_URGENT_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'extra_urgent_price';
        }
        if ($this->isColumnModified(ServicesTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(ServicesTableMap::COL_UPDATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'id_service_category':
                        $stmt->bindValue($identifier, $this->id_service_category, PDO::PARAM_INT);
                        break;
                    case 'description':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getIdServiceCategory();
                break;
            case 2:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getIdServiceCategory(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aServiceCategories) {
                ...
                $result[$key] = $this->aServiceCategories->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setIdServiceCategory($value);
                break;
            case 2:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setIdServiceCategory($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ServicesTableMap::COL_ID_SERVICE_CATEGORY)) {
            $criteria->add(ServicesTableMap::COL_ID_SERVICE_CATEGORY, $this->id_service_category);
        }
        if ($this->isColumnModified(ServicesTableMap::COL_DESCRIPTION)) {
            $criteria->add(ServicesTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(ServicesTableMap::COL_NORMAL_PRICE)) {
            $criteria->add(ServicesTableMap::COL_NORMAL_PRICE, $this->normal_price);
        }
        if ($this->isColumnModified(ServicesTableMap::COL_URGENT_PRICE)) {
            $criteria->add(ServicesTableMap::COL_URGENT_PRICE, $this->urgent_price);
        }
        if ($this->isColumnModified(ServicesTableMap::COL_EXTRA_URGENT_PRICE)) {
            $criteria->add(ServicesTableMap::COL_EXTRA_URGENT_PRICE, $this->extra_urgent_price);
        }
        if ($this->isColumnModified(ServicesTableMap::COL_CREATED_AT)) {
            $criteria->add(ServicesTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(ServicesTableMap::COL_UPDATED_AT)) {
            $criteria->add(ServicesTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $copyObj->setIdServiceCategory($this->getIdServiceCategory());
    ...
    /**
     * Declares an association between this object and a ChildServiceCategories object.
     *
     * @param  ChildServiceCategories $v
     * @return $this|\Services The current object (for fluent API support)
     * @throws PropelException
     */
    public function setServiceCategories(ChildServiceCategories $v = null)
    {
        if ($v === null) {
            $this->setIdServiceCategory(NULL);
        } else {
            $this->setIdServiceCategory($v->getId());
        }

        $this->aServiceCategories = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildServiceCategories object, it will not be re-added.
        if ($v !== null) {
            $v->addServices($this);
        }
    ...
    /**
     * Get the associated ChildServiceCategories object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildServiceCategories The associated ChildServiceCategories object.
     * @throws PropelException
     */
    public function getServiceCategories(ConnectionInterface $con = null)
    {
        if ($this->aServiceCategories === null && ($this->id_service_category != 0)) {
            $this->aServiceCategories = ChildServiceCategoriesQuery::create()->findPk($this->id_service_category, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aServiceCategories->addServicess($this);
             */
        }

        return $this->aServiceCategories;
    }
    ...
    public function setBranchOfficeServicess(Collection $branchOfficeServicess, ConnectionInterface $con = null)
    {
        ...
        foreach ($branchOfficeServicessToDelete as $branchOfficeServicesRemoved) {
            $branchOfficeServicesRemoved->setServices(null);
        }
    ...
    protected function doAddBranchOfficeServices(ChildBranchOfficeServices $branchOfficeServices)
    {
        ...
        $branchOfficeServices->setServices($this);
    }
    ...
    public function removeBranchOfficeServices(ChildBranchOfficeServices $branchOfficeServices)
    {
        if ($this->getBranchOfficeServicess()->contains($branchOfficeServices)) {
            ...
            $branchOfficeServices->setServices(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildBranchOfficeServices}> List of ChildBranchOfficeServices objects
     */
    public function getBranchOfficeServicessJoinBranchOffices(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBranchOfficeServicesQuery::create(null, $criteria);
    ...
    public function setOrderDetails(Collection $orderDetails, ConnectionInterface $con = null)
    {
        ...
        foreach ($orderDetailsToDelete as $orderDetailRemoved) {
            $orderDetailRemoved->setServices(null);
        }
    ...
    {
        if (null !== $this->aServiceCategories) {
            $this->aServiceCategories->removeServices($this);
        }
        $this->id = null;
        $this->id_service_category = null;
