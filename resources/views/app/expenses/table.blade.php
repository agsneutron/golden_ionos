                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="javascript:void(0)" onclick='editExpense({{ $expense['Id'] }},this)'>Editar</a></li>
                            <li class="divider"></li>
                            <li>
                                <a class="text-danger" href="javascript:void(0)" onclick='deleteExpense({{ $expense['Id'] }},this)'>Eliminar</a>
                            </li>
                        </ul>
                    </div>
                </td>
