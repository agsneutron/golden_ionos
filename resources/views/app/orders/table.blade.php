    ...
    <table id='dataTableOrders' class='table table-striped table-bordered table-hover'>
        ...
        @foreach($orders as $order)
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <!-- <li><a href="{{ route('orders.view_order',  $order['Id']) }}" target="_blank">Ver detalle</a></li> -->
                ...
                <td align="right">{{ $order['RealDeliveryDate'] }}<br>{{ $order['RealDeliveryTime'] }}</td>
                <td align="right">{{ $order['NameDaliveryUser'] }}</td>
                <?php $n++; ?>
            </tr>
        @endforeach
        </tbody>
