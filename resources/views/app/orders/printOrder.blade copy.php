...
<body>
    ...
    <table style="width: 100%" >
        <tr>
            <td style="width: 408px; position: absolute">
                <table style="width: 96%; font-size: 12px; margin-left: 7%; border: 1px solid #000000; position: relative">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="5" align="center">
                                    <img src="{{ base_path().'/public/graphics/logo_md.png' }}" style="width: 3cm" />
                            ...
                            <tr >
                                ...
                                <td colspan="3" style="border-bottom: 1px solid #000000">
                                    <h3>{{ $order['BranchSeries']." ".$order['Folio'] }}</h3>
                                </td>
                            </tr>
                            <tr >
                            ...
                            <?php
                                if($detail['IdService']== 1 || $detail['IdService']==5){
                            ...
                            <tr >
                                <td colspan="3" style="border-bottom: 1px solid #000000">
                                <h6><strong>Kilos: </strong>{{ $kilogramos }}</h6>
                                </td>
                                <td colspan="3" style="border-bottom: 1px solid #000000">
                                    <h6><strong>Piezas: </strong>{{ $piezas }}</h6>
                                </td>
                                <td colspan="6" style="border-bottom: 1px solid #000000"></td>
                            </tr>
                            <tr >
                                <td colspan="12" style="border-bottom: 1px solid #000000">
                                    <h6><strong>Entrega: </strong> {{ $calendar['Name']." ".$order['DeliveryTime'] }}</h6>
                                </td>
                            </tr>
                            <tr >
                                <td colspan="6" >
            ...
            <td class="width: 408px">
                <table style="width: 95%; font-size: 12px; border: 1px solid #000000">
                            <tr>
                                <td style="width: 8.33333333%">&nbsp;</td>
                                <td style="width: 8.33333333%">&nbsp;</td>
                                <td style="width: 8.33333333%">&nbsp;</td>
